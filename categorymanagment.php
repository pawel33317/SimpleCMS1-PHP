...
include 'class/categorymanagment.php';
...
$categorymanagment = new categorymanagment($db);
$logo = new logo();
//opcje admina
...
//ARTYKUŁ
$smarty->assign("article",$categorymanagment->wynik);
//FOOTER
...
//Szczegóły
$smarty->assign("details",$categorymanagment->details());
//Wyświetlanie
